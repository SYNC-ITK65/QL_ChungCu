...
values  (1, N'Hành lang tầng 1 bẩn', N'Hành lang tầng 1 có rác chưa được dọn từ sáng sớm, gây mùi khó chịu.', '2026-04-28 09:00:00', N'Đã điều nhân viên vệ sinh kiểm tra và dọn dẹp lúc 10h30.', '2026-04-28 10:30:00', 'Chờ xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (3, N'Tiếng ồn ban đêm từ tầng trên', N'Căn hộ tầng trên thường xuyên gây tiếng ồn sau 23h, ảnh hưởng giấc ngủ.', '2026-04-20 23:30:00', 'Đã nhắc nhở chủ hộ tầng trên tuân thủ nội quy giờ yên lặng.', '2026-04-21 09:00:00', 'Chờ xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (7, N'Đèn hành lang bị nhấp nháy', N'Đèn LED trước cửa căn hộ A1-03 nhấp nháy liên tục từ tuần trước.', '2026-05-01 19:00:00', '', null, 'Đang xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        ...
        (5, N'Bồn hoa lối vào xuống cấp', N'Bồn hoa trang trí lối vào Block A bị vỡ và cây chết, trông mất thẩm mỹ.', '2026-05-05 10:00:00', N'Ghi nhận, đã lên kế hoạch cải tạo cảnh quan vào tháng 6.', '2026-05-06 08:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (4, N'Bãi xe đầy, không có chỗ gửi', N'Tầng hầm B1 thường xuyên hết chỗ từ 18h-20h, xe phải gửi bên ngoài tốn thêm chi phí.', '2026-05-07 20:00:00', N'Đang nghiên cứu thêm khu vực gửi xe phụ tại tầng hầm B2.', '2026-05-08 09:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (8, N'Nước yếu vào giờ cao điểm', N'Áp lực nước rất yếu vào buổi sáng từ 6h-8h, không đủ dùng sinh hoạt.', '2026-05-09 07:30:00', null, null, null, 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (9, N'Cửa kính sảnh bị hỏng khóa', N'Cửa kính sảnh tầng trệt Block B không đóng được chặt, gây mất an ninh.', '2026-05-10 11:00:00', N'Đã sửa chữa khóa cửa ngay trong ngày.', '2026-05-10 15:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (6, N'Hồ bơi nhiều rong rêu', N'Hồ bơi có váng màu xanh và rong rêu ở góc bể, e ngại vệ sinh.', '2026-05-11 16:00:00', N'Đã xong nước và vệ sinh hồ bơi, hoạt động bình thường từ 13/5.', '2026-05-12 08:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (10, N'Rò rỉ nước từ tầng trên', N'Tường phòng khách bị rò rỉ nước khiến sơn bị ướt và nứt.', '2026-05-12 10:00:00', N'Đã yêu cầu cư dân tầng trên kiểm tra và khắc phục.', '2026-05-13 09:00:00', 'Đang xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (11, N'Chất lượng nước sinh hoạt', N'Nước có mùi lạ và màu hơi vàng, không rõ là do ống hay bể chứa.', '2026-05-13 08:00:00', N'Đã kiểm tra hệ thống, sẽ vệ sinh bể chứa tuần tới.', '2026-05-14 15:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (12, N'Mất nước áp lực', N'Áp lực nước bị mất hoàn toàn trong 2 giờ tối hôm 14/5.', '2026-05-14 18:00:00', null, null, null, 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (1, N'Thông thoáng gió kém', N'Hệ thống thông khí chung không hoạt động, gây ẩm mốc.', '2026-05-15 12:00:00', N'Đã kiểm tra và làm sạch ống thông khí.', '2026-05-16 10:00:00', 'Đang xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (3, N'Tủ điện chung bị khóa sai', N'Cánh tủ điện chung tầng 3 khóa không khít, gây nguy hiểm.', '2026-05-16 09:00:00', N'Đã sửa lại khóa và kiểm tra an toàn.', '2026-05-16 14:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (5, N'Sảnh lối ra vào bị bẩn', N'Sảnh chính tòa nhà chưa được lau dọn từ sáng sớm.', '2026-05-17 07:00:00', N'Đã nhắc nhở nhân viên vệ sinh kiểm tra thêm lần.', '2026-05-17 08:00:00', 'Đã xong', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (8, N'Bậc cầu thang bị nứt', N'Một vài bậc cầu thang tầng 8 bị nứt, có nguy hiểm trơn trượt.', '2026-05-18 14:00:00', N'Đã báo đơn vị sửa chữa, dự kiến sửa tuần sau.', '2026-05-19 09:00:00', 'Đang xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780563759/canho/g4iltpgjlfuavc5twyt0.jpg'),
        (1, N'Hư máy lạnh', N'Máy lạnh hư không thể sử dụng
Vui lòng sửa gấp', '2026-06-04 19:17:20', null, null, null, 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780575441/canho/l9nvkzffb9fzxqvoebv7.png');
