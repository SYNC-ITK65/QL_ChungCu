...
values  (1, N'Hành lang tầng 1 bẩn', N'Hành lang tầng 1 có rác chưa được dọn từ sáng sớm, gây mùi khó chịu.', '2026-04-28 09:00:00', N'Đã điều nhân viên vệ sinh kiểm tra và dọn dẹp lúc 10h30.', '2026-04-28 10:30:00', N'Chờ xử lý', null),
        ...
        (8, N'Bậc cầu thang bị nứt', N'Một vài bậc cầu thang tầng 8 bị nứt, có nguy hiểm trơn trượt.', '2026-₀5-18 14:₀₀:₀₀', N'Đã báo đơn vị sửa chữa, dự kiến sửa tuần sau.', '2₀₂₆-₀₅-₁₉ ₀₉:₀₀:₀₀', N'Đang xử lý', null),
        (1, N'Hư máy lạnh', N'Máy lạnh hư không thể sử dụng
    Vui lòng sửa gấp', '2026-06-04 19:17:20', null, null, N'Chờ xử lý', 'https://res.cloudinary.com/dtr8hrxlt/image/upload/v1780575441/canho/l9nvkzffb9fzxqvoebv7.png');
