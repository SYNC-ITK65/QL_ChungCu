...
INSERT INTO phuong_tien (can_ho_id, bien_so, loai, mau_sac, trang_thai, hinh_anh) VALUES
    (1,'29A-123.45', N'Xe máy',  N'Đỏ',       N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (1,'30H-999.88', N'Ô tô',    N'Trắng',    N'Chờ duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (1,'29C-111.22', N'Xe máy',  N'Đen',      N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (2,'29C-567.89', N'Xe máy',  N'Xanh',     N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (3,'51G-444.22', N'Ô tô',    N'Đen',      N'Từ chối', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (3,'29P-222.11', N'Xe máy',  N'Bạc',      N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (4,'30K-555.66', N'Xe máy',  N'Trắng',    N'Chờ duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (4,'29T-777.33', N'Ô tô',    N'Xám',      N'Đã duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (5,'29D-888.99', N'Xe máy',  N'Xám',      N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (6,'51B-100.10', N'Xe đạp',  N'Xanh lá',  N'Từ chối', 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=600'),
    (6,'29A-200.20', N'Xe máy',  N'Vàng',     N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (7,'30G-300.30', N'Xe máy',  N'Đỏ',       N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (8,'29E-400.40', N'Ô tô',    N'Xanh navy',N'Chờ duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (8,'29K-500.50', N'Xe máy',  N'Trắng',    N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (9,'51H-600.60', N'Xe máy',  N'Đen',      N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (10,'51M-777.77', N'Xe máy', N'Đỏ',       N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (11,'29X-888.88', N'Ô tô',   N'Trắng',    N'Chờ duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (12,'51N-999.99', N'Xe đạp', N'Xanh',     N'Đã duyệt', 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=600'),
    (13,'30M-111.11', N'Xe máy', N'Vàng',     N'Từ chối', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (1,'29R-222.22', N'Ô tô',    N'Đen',      N'Đã duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (2,'51P-333.33', N'Xe máy',  N'Bạc',      N'Chờ duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (3,'29Q-444.44', N'Xe máy',  N'Xám',      N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (4,'51Q-555.55', N'Xe đạp',  N'Xanh lá',  N'Đã duyệt', 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=600'),
    (5,'29S-666.66', N'Ô tô',    N'Bạc',      N'Từ chối', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600'),
    (6,'30N-777.77', N'Xe máy',  N'Trắng',    N'Đã duyệt', 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600'),
    (7,'29T-888.88', N'Ô tô',    N'Đỏ',       N'Chờ duyệt', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=600');
