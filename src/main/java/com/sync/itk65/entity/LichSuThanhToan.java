...
@Entity
@Table(name = "lich_su_thanh_toan", uniqueConstraints = @UniqueConstraint(columnNames = "hoa_don_id", name = "uk_hoa_don_id"))
public class LichSuThanhToan {
    ...
    private String phuongThucThanhToan; // "Tiền mặt", "Chuyển khoản", "Ví điện tử", v.v.
    ...
    private String trangThaiSua; // "Đang sửa", "Đã sửa", "Không sửa"
    ...
    public String getTrangThaiSua() {
        return trangThaiSua;
    }

    public void setTrangThaiSua(String trangThaiSua) {
